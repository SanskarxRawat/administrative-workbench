...
exports.createTable = (papers) => {
    ...
    const headRow = new TableRow({
        children: [
            ...
            new TableCell({
                children: [
                    new Paragraph('Journal')
                ],
            }),
            new TableCell({
                children: [
                    new Paragraph('Publisher')
                ],
            }),
            new TableCell({
                children: [
                    new Paragraph('Volume/Issue No./ISSN')
                ],
            }),
            new TableCell({
                children: [
            ...
            new TableCell({
                children: [
                    new Paragraph('Pubmad Listed')
                ],
            }),
            new TableCell({
                children: [
                    new Paragraph('MMU Affiliation')
                ],
            }),
            new TableCell({
                children: [
            ...
            new TableCell({
                children: [
                    new Paragraph('Month Of Publication')
                ],
            }),
            new TableCell({
                children: [
                    new Paragraph('Year Of Publication')
                ],
            }),
            new TableCell({
                children: [
    ...
    papers.forEach(async (item, index) => {
        const row = new TableRow({
            children : [
                ...
                new TableCell({
                    children : [new Paragraph(`${item.manuscriptTitle}`)]
                }),new TableCell({
                    children : [new Paragraph(`${item.fullJournalName}`)]
                }),new TableCell({
                    children : [new Paragraph(`${item.publisher}`)]
                }),new TableCell({
                    children : [new Paragraph(`${item.doi}`)]
                }),new TableCell({
                    ...
                    children : [new Paragraph(`${item.publicationType}`)]
                }),new TableCell({
